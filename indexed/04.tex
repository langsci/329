...
Now, present-day Swedish is different, and we have argued that the change should not be understood as a change in branching or argument shifts. Instead, we propose that the \isi{particle} has been reanalyzed as the head of the \isi{Result phrase}; the structure is given in \REF{ex:lalu:55}.
