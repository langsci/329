...
The corpus of \ili{Swedish} drama dialogue consists of 45 original \ili{Swedish} dramas written between 1725 and 2000. They are partitioned into six periods of 25 years (with 25 years between each period), two in each century, where the three earliest periods contain five dramas each, while the three latter contain ten dramas each. The periods, the number of dramas, and the number of words of the corpus are given in \tabref{tab:delsing:2}. For details on the individual dramas, see \citet{MarttalaStromquist2001} or \citet[38–39 and Appendix 1]{Stroh-Wollin2008}.
