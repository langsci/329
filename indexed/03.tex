...
The examples in (\ref{ex:valdeson:1}--\ref{ex:valdeson:7}) illustrate how the \isi{double object construction} is used in present-day Swedish.\footnote{In all examples presented in this paper, the \isi{ditransitive verb} is in boldface.}
