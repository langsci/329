...
Comparing the examples in \REF{ex:delsing:1} and \REF{ex:delsing:3}, we note that the agreement pattern has changed. The former neuter singular form \textit{mycket} (as in \ref{ex:delsing:3b}) has spread, and is now used with all nouns (common gender singular as well as plural, as shown in \ref{ex:delsing:1}).\largerpage[2.5]
