...
Note that phrases may be assigned to the ambiguous group (as in \ref{ex:delsing:12}) for two reasons: either because there seems to be agreement in the neuter (which was found both before and after the change, as in \ref{ex:delsing:12a}), or because the head noun is ambiguous between singular and plural (which is the case with most neuter nouns), and therefore might be an instance of neuter agreement in the singular (as in \ref{ex:delsing:12b}).\largerpage[1.5]
