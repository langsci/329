...
Since complements of prepositions are sometimes implicit in Old Swedish PPs, one could analyse examples like \REF{ex:lalu:30} in much the same way as cases with explicit possessors, like \REF{ex:lalu:31}. In other words, it is possible that examples like \REF{ex:lalu:31} also should not be treated on a par with other particle constructions.
...
\lsptoprule
Text & \multicolumn{3}{l}{Particle–pronoun} & \multicolumn{2}{c}{Particle–DP} & \multicolumn{2}{c}{Total}\\
\midrule
\textit{Didrik} (ca. 1450) & 2/18 & (11\%) & & 41/97 & (42\%) & 43/115 & (37\%)\\
Swart (1560) & 3/26 & (12\%) & & 35/74 & (47\%) & 38/100 & (38\%)\\
...
\ea Present-day Swedish\label{ex:lalu:70}
\ea
...
\z
\ex Present-day Norwegian\label{ex:lalu:71}
\ea
